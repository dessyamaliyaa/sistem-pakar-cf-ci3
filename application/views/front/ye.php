    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <?php if(sizeof($listPenyakit)>0) { ?>
                <p>
                    Berdasarkan gejalanya, Pasien di prediksi mengidap penyakit <b><?php echo $dataHasil['nilai_cf'];?></b> dengan tingkat kepercayaan <b><?php echo $dataHasil['nilai_cf'];?> %</b><br/>
                    <?php echo $dataHasil['nilai_cf'];?>. <p style="font-style: bold; color: red; font-size: 13px;">*Hasil diagnosa ini masih membutuhkan pemeriksaan lebih lanjut.</p>
                </p>
            <?php }else{?>
                <p>
        ...
        <div class="box-footer clearfix">
            <a class="btn btn-sm btn-flat pull-right" style="background: #67CDFF; color: white;" href="">Deteksi Ulang</a>
