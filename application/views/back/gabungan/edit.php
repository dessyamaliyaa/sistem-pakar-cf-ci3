            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                    <div class="form-element-list">
                        <div class="row">                           
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <form action="<?php echo base_url('gabungan/ubah/'.$gabungan->id_gabungan); ?>" method="post">
                                                ...
                                                <div class="nk-int-st">
                                                    <div class="chosen-select-act fm-cmp-mg">
                                                        <select class="chosen" class="form-control" data-placeholder="Pilih Penyakit..." name="id_penyakit">
                                                                <option value="<?= $gabungan->id_penyakit ?>"><?php echo $gabungan->nama_penyakit?></option>
                                                                <option value="">===</option>
                                                ...
                                                <div class="nk-int-st">
                                                    <div class="chosen-select-act fm-cmp-mg">
                                                        <select class="chosen" class="form-control" data-placeholder="Pilih Gejala..." name="id_gejala">
                                                                <option value="<?php echo $gabungan->id_gejala ?>"><?php echo $gabungan->nama_gejala?></option>
                                                                <option value="">===</option>
                                            ...
                                            <div class="form-group ic-cmp-int">
                                                ...
                                                <div class="nk-int-st">
                                                    <select name="nilai_mb" id="nilai_mb" class="form-control form-control-lg form-control-a" required>
                                                        <option value="<?php echo $gabungan->nilai_mb ?>"><?php if ($gabungan->nilai_mb=="0"){
                                                            ?>- Tidak Tahu atau Tidak Yakin -<?php } elseif ($gabungan->nilai_mb=="0.2"){
                                                            ?>- Hampir Mungkin -<?php } elseif ($gabungan->nilai_mb=="0.4"){
                                                            ?>- Mungkin -<?php }elseif ($gabungan->nilai_mb=="0.6"){
                                                            ?>- Kemungkinan Besar -<?php }elseif ($gabungan->nilai_mb=="0.8"){
                                                            ?>- Hampir Pasti -<?php }elseif ($gabungan->nilai_mb=="1.0"){
                                                            ?>- Pasti Ya -<?php }?>
                                                        </option>
                                            ...
                                            <div class="form-group ic-cmp-int">
                                                ...
                                                <div class="nk-int-st">
                                                    <select name="nilai_md" id="nilai_md" class="form-control form-control-lg form-control-a" required>
                                                        <option value="<?php echo $gabungan->nilai_md ?>"><?php if ($gabungan->nilai_md=="0"){
                                                            ?>- Tidak Tahu atau Tidak Yakin -<?php } elseif ($gabungan->nilai_md=="0.2"){
                                                            ?>- Hampir Mungkin -<?php } elseif ($gabungan->nilai_md=="0.4"){
                                                            ?>- Mungkin -<?php }elseif ($gabungan->nilai_md=="0.6"){
                                                            ?>- Kemungkinan Besar -<?php }elseif ($gabungan->nilai_md=="0.8"){
                                                            ?>- Hampir Pasti -<?php }elseif ($gabungan->nilai_md=="1.0"){
                                                            ?>- Pasti Ya -<?php }?>
                                                        </option>
                                                        <option value="1.0">Pasti Ya</option>
                                                        <option value="0.8">Hampir Pasti</option>
