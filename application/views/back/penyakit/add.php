					        ...
					        <form action="<?= base_url('penyakit/tambah');?>" method="post">
					            <div class="form-group">					            	
					                ...
					                <label>Nama Penyakit</label>
					                    <input type="text" autofocus="" autocomplete="off" name="nama_penyakit" class="form-control" placeholder="Nama Penyakit *">
					                </div>
					            </div>					            
					            <div class="form-group">					            	
                                    <div class="nk-int-st">
					                <label>Keterangan Penyakit</label>
					                    <textarea id="mytextarea" name="keterangan" value="123"></textarea>
					                </div>
					            </div>
