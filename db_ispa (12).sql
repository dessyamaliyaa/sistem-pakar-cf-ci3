...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Agu 2022 pada 21.39
...
(13, 'poo', '$2y$10$RQVEYVdWJn9RwTz8cbG9Wed.PRqqWVz/D3aOkwyobls.wFWAdN0py', 'poo', 'admin');
...
(57, 1, 37, 8, 'pakar', 0.6, 0.2),
(58, 1, 38, 8, 'pakar', 0.6, 0.2),
(59, 1, 39, 8, 'pakar', 0.6, 0.2),
(60, 1, 40, 8, 'pakar', 0.4, 0.2),
(61, 1, 41, 8, 'pakar', 0.6, 0.2),
(62, 1, 42, 8, 'pakar', 0.6, 0),
(63, 1, 43, 8, 'pakar', 0.4, 0),
(64, 1, 46, 8, 'pakar', 0.8, 0),
(65, 2, 36, 8, 'pakar', 0.6, 0.2),
(66, 2, 37, 8, 'pakar', 0.6, 0),
(67, 2, 38, 8, 'pakar', 0.8, 0.2),
(68, 2, 39, 8, 'pakar', 0.6, 0),
(69, 2, 40, 8, 'pakar', 0.6, 0.2),
(70, 2, 41, 8, 'pakar', 0.6, 0.2),
(71, 2, 42, 8, 'pakar', 0.6, 0),
(72, 3, 36, 8, 'pakar', 0.6, 0),
(73, 3, 37, 8, 'pakar', 0.6, 0),
(74, 3, 38, 8, 'pakar', 0.6, 0),
(75, 3, 39, 8, 'pakar', 0.4, 0),
(76, 3, 40, 8, 'pakar', 0.4, 0),
(77, 3, 41, 8, 'pakar', 0.4, 0),
(78, 3, 42, 8, 'pakar', 0.6, 0),
(79, 3, 43, 8, 'pakar', 0.6, 0.2),
(80, 3, 46, 8, 'pakar', 0.8, 0),
(81, 4, 36, 8, 'pakar', 0.6, 0.2),
(82, 4, 37, 8, 'pakar', 0.8, 0),
(83, 4, 38, 8, 'pakar', 0.6, 0.2),
(84, 4, 39, 8, 'pakar', 0.4, 0),
(85, 4, 40, 8, 'pakar', 0.4, 0),
(86, 4, 41, 8, 'pakar', 0.6, 0),
(87, 4, 42, 8, 'pakar', 0.6, 0),
(88, 4, 43, 8, 'pakar', 0.4, 0),
(89, 5, 36, 8, 'pakar', 0.6, 0),
(90, 5, 37, 8, 'pakar', 0.8, 0.2),
(91, 5, 38, 8, 'pakar', 0.6, 0),
(92, 5, 39, 8, 'pakar', 0.6, 0.2),
(93, 5, 40, 8, 'pakar', 0.6, 0),
(94, 5, 41, 8, 'pakar', 0.4, 0),
(95, 5, 42, 8, 'pakar', 0.6, 0),
(96, 5, 43, 8, 'pakar', 0.6, 0.2),
(97, 5, 44, 8, 'pakar', 0.6, 0),
(98, 5, 45, 8, 'pakar', 0.6, 0);
...
(36, 'Demam', 8, 'pakar'),
(37, 'Sesak napas atau napas cepat', 2, 'admin'),
(38, 'Batuk ya', 8, 'pakar'),
(39, 'Pilek', 2, 'admin'),
(40, 'Nafsu makan berkurang', 2, 'admin'),
(41, 'Sakit kepala', 2, 'admin'),
(42, 'Mengi atau napas berbunyi', 2, 'admin'),
(43, 'Suara serak', 2, 'admin'),
(44, 'Nyeri saat menelan', 2, 'admin'),
(45, 'Sulit bicara', 2, 'admin'),
(46, 'Nyeri dada', 2, 'admin'),
(70, 'yuhu', 2, 'admin'),
(71, 'ia', 13, 'admin'),
(72, 'add', 13, 'admin'),
(73, 'jdaq', 8, 'pakar');
...
(8, 2, 'dr. Noor Anggrainy Retnowati, Sp. A.', 'pakar', '$2y$10$NxQnbt0zY9YDRd1wKTNQbupzDhLBS79yUmBCoYa36x0DQjcN8xz/m', '932-481MW', '085732845920', 'pakar'),
(15, 2, 'poo', 'pooh', '$2y$10$.Q.fkhTcyZGGsNvy1fA4Juw9UvXJyzn2/XvwP5eVpJdAMiNvjY4tS', 'poo', '0232032', 'pakar');
...
--
ALTER TABLE `tb_gejala`
  MODIFY `id_gejala` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
...
--
ALTER TABLE `tb_pakar`
  MODIFY `id_pakar` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT untuk tabel `tb_penyakit`
--
ALTER TABLE `tb_penyakit`
  MODIFY `id_penyakit` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
COMMIT;
